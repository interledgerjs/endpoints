import 'mocha'
import { StreamEndpoint, StreamEndpointOptions, EndpointCodecs } from '../src/stream-endpoint'
import * as Chai from 'chai'
import * as chaiAsPromised from 'chai-as-promised'
import { MessageFrame } from '../src/frame';
import { Readable, Writable, Transform, Duplex, TransformCallback } from 'stream';
import { isEndpoint } from '../src/endpoint';
const { expect } = Chai
